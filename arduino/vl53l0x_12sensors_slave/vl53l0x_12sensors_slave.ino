...
typedef enum {
    SHT_LOX_SENSOR1_0_DEG,
    SHT_LOX_SENSOR2_15_DEG,
    SHT_LOX_SENSOR3_30_DEG,
    SHT_LOX_SENSOR4_45_DEG,
    SHT_LOX_SENSOR5_60_DEG,
    SHT_LOX_SENSOR6_75_DEG,
    SHT_LOX_SENSOR7_90_DEG,
    SHT_LOX_SENSOR8_105_DEG,
    SHT_LOX_SENSOR9_120_DEG,
    SHT_LOX_SENSOR10_135_DEG,
    SHT_LOX_SENSOR11_150_DEG,
    SHT_LOX_SENSOR12_165_DEG = 40,
    SHT_LOX_SENSOR13_180_DEG = 26,
    SHT_LOX_SENSOR14_195_DEG = 24,
    SHT_LOX_SENSOR15_210_DEG = 22,
    SHT_LOX_SENSOR16_225_DEG = 32,
    SHT_LOX_SENSOR17_240_DEG = 30,
    SHT_LOX_SENSOR18_255_DEG = 28,
    SHT_LOX_SENSOR19_270_DEG = 38,
    SHT_LOX_SENSOR20_285_DEG = 36,
    SHT_LOX_SENSOR21_300_DEG = 34,
    SHT_LOX_SENSOR22_315_DEG = 44,
    SHT_LOX_SENSOR23_330_DEG = 42,
    SHT_LOX_SENSOR24_345_DEG
} sht_lox_pins_e;
...
sht_lox_pins_e shut_pins[SENSORS_NUM] = {
   [0] =  SHT_LOX_SENSOR12_165_DEG,
   [1] =  SHT_LOX_SENSOR13_180_DEG,
   [2] =  SHT_LOX_SENSOR14_195_DEG,
   [3] =  SHT_LOX_SENSOR15_210_DEG,
   [4] =  SHT_LOX_SENSOR16_225_DEG,
   [5] =  SHT_LOX_SENSOR17_240_DEG,
   [6] =  SHT_LOX_SENSOR18_255_DEG,
   [7] =  SHT_LOX_SENSOR19_270_DEG,
   [8] =  SHT_LOX_SENSOR20_285_DEG,
   [9] =  SHT_LOX_SENSOR21_300_DEG,
   [10] = SHT_LOX_SENSOR22_315_DEG,
   [11] = SHT_LOX_SENSOR23_330_DEG
};
